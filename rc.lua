...
mytextclock = awful.widget.textclock("%Y-%m-%d %I:%M.%S%p %a", 1)
...
globalkeys = awful.util.table.join(
   globalkeys,
   -- awful.key({"Control","Alt"}, "l", function () awful.util.spawn("bash /home/j0sh/Dropbox/bin/lock_screen_with_i3lock.sh") end),
   awful.key({"Alt"}, "Tab",
    function ()
